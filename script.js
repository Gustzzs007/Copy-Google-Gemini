...
const GOOGLE_API_KEY = "AIzaSyB4ZgqFTRq6lD_YIVBWNR6LCvWXj_yrKTU";
  ...
  savedConversations.forEach((conversation) => {
    ...
    const userMessageHtml = `
            ...
            <div class="message__content">
                <img class="message__avatar" src="assents/profile.png" alt="User avatar">
    ...
    const responseHtml = `
           ...
           <div class="message__content">
                <img class="message__avatar" src="assents/gemini.svg" alt="Gemini avatar">
